...
export function build(options) {
	let opts = $.extend({ // defaults
		...
		dragNode: true,
		showWidgets: true,
		removePersonCallback: function (person, rebuildCallback, dataset){ return true;},
		linkPartnersCallback: function (partner1, partner2, rebuildCallback, dataset){return true;},
		addRelativeCallback: function (person, relationship, subtype, rebuildCallback, dataset){return true;},
